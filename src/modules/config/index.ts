...
export const configController = new Elysia({ prefix: '/config', name: 'Config', detail: { tags: ['Config'] } })
    .use(requireAdmin)
    .get('/', async ({ query }) => {
