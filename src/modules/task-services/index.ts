...
export const taskServiceController = new Elysia({ prefix: '/task-services', name: 'TaskServices', detail: { tags: ['Task Services'] } })
    .use(requireAuth)
    .get('/', async ({ query }) => {
    ...
    }, { query: paginationQuery, detail: { tags: ['Task Services'] } })
