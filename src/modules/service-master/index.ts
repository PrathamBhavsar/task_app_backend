...
export const serviceMasterController = new Elysia({ prefix: '/service-master', name: 'ServiceMaster' })
    .use(requireAuth)
    .get('/', async ({ query }) => {
