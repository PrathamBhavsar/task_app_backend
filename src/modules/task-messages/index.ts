...
export const taskMessageController = new Elysia({ prefix: '/task-messages', name: 'TaskMessages' })
    .use(requireAuth)
    .get('/', async ({ query }) => {
